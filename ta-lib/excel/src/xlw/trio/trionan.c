/*************************************************************************
 *
 * $Id: trionan.c 203 2003-06-09 05:40:57Z fortier $
 *
...
/* static TRIO_CONST char rcsid[] = "@(#)$Id: trionan.c 203 2003-06-09 05:40:57Z fortier $"; */
...
trio_make_double(TRIO_CONST unsigned char *values)
{
  ...
  for (i = 0; i < (int)sizeof(double); i++) {
    ((TRIO_VOLATILE unsigned char *)&result)[TRIO_DOUBLE_INDEX(i)] =
      values[i];
  }
  return result;
}
